...
9. 「前投薬」グループ（sort_order=1, group_type="前投薬"）には以下を必ず含めること:
   ...
   ■ 高度催吐リスク（HEC: シスプラチン・カルボプラチンAUC≥4・シクロホスファミド≥1500mg/m2 等）:
     - デキサメタゾン（デカドロン）: 6.6mg 静注 Day 1（+必要に応じDay 2-4追加）
     - グラニセトロン（カイトリル）1mg 静注 or パロノセトロン（アロキシ）0.75mg 静注 Day 1
     - アプレピタント（イメンド）125mg 経口 Day 1 → 80mg Day 2,3  または NK1RA注射製剤
     - オランザピン（ジプレキサ）5mg 経口 Day 1-4（高リスク追加選択肢）
   ■ 中等度催吐リスク（MEC: オキサリプラチン・カルボプラチンAUC<4・イリノテカン・シクロホスファミド<1500mg/m2・リツキシマブ 等）:
     - デキサメタゾン（デカドロン）: 6.6mg 静注 Day 1
     - グラニセトロン（カイトリル）1mg 静注 or パロノセトロン（アロキシ）0.75mg 静注 Day 1
     - アプレピタント（イメンド）: レジメン・施設に応じて追加（MEC一部推奨）
