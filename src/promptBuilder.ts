...
13. 投与方法（administration_method）の正確性を必ず守ること（特導事項）:
    - 皮下注射（sc）と静脈内投乎（iv/点滴）の区別を絶対間違えないこと:
      - ボルテゾミブ（ベルケイド）: sc（皮下注射）が目下の標準。IV点滴は旧式のみ。
      - ダラツムマブ（ダラザレクス）: 点滴（通常IV）。ダラザレクスSCは別制剤。
      - リツキシマブ（リツキサン）: 点滴IV（標準） or リツキサンSC製剤。指定様式を守ること。
      - サリドマイド: 必ず経口。
      - 学璵嘘（レナリドミド-のみ）: 経口のみ。
